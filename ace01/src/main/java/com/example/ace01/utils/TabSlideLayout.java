...
public class TabSlideLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private ArrayList<String> mTitles, mIconTitles;
    ...
    public TabSlideLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressWarnings("ResourceType")
    public TabSlideLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorHeight = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_height,
                dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 6 : (mIndicatorStyle == STYLE_BLOCK ? -1 : 2)));
     ...
     * 关联ViewPager
     */
    public void setViewPager(ViewPager vp, int flag, ArrayList<String> iconlist) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
        this.mViewPager = vp;
        this.showFlag = flag;
        this.mIconTitles = iconlist;
     ...
     */
    public void setViewPager(ViewPager vp, String[] titles, int flag) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
     ...
     */
    public void setViewPager(ViewPager vp, String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments, int flag) {
        if (vp == null) {
    ...
    public void notifyDataSetChanged(int flag) {
        ...
        if (flag == 1) {
            this.mTabCount = mIconTitles == null ? mViewPager.getAdapter().getCount() : mIconTitles.size();
        } else {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (flag == 1) {
                addIconTab(i, mIconTitles.get(i), tabView);
            } else {
    ...
    private void addIconTab(final int position, String title, View tabView) {
        TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
        tv_tab_title.setVisibility(View.GONE);
        final ImageView iv_tab_title = (ImageView) tabView.findViewById(R.id.iv_tab_title);
    ...
    private void updateIconTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (iv_tab_title != null) {
                iv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            }
        }
    }
    ...
    public void onPageSelected(int position) {
        if (showFlag == 0) {
            ...
            updateIconTabSelection(position);
        }
    }
    ...
    private void updateIconTabSelection(int position) {
        int size;
        if (mTabCount <= mIconTitles.size()) {
            size = mTabCount;
        } else {
            size = mIconTitles.size();
        }
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            TextView tab_title = (TextView) currentTabView.findViewById(tv_tab_title);
        ...
        if (this.mCurrentTab < mTabCount - 1) {
            ...
            //for mIndicatorWidthEqualTitle
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                TextView next_tab_title = (TextView) nextTabView.findViewById(tv_tab_title);
                mTextPaint.setTextSize(mTextsize);
    ...
    public TextView getTitleView(int tab) {
        ...
        iv_tab_title.setVisibility(View.GONE);
        return tv_tab_title;
    }

    public ImageView getIcoiTitleView(int tab) {
        View tabView = mTabsContainer.getChildAt(tab);
        TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
        tv_tab_title.setVisibility(View.GONE);
        ImageView iv_tab_title = (ImageView) tabView.findViewById(R.id.iv_tab_title);
        ...
        if (state instanceof Bundle) {
            ...
            if (mCurrentTab != 0 && mTabsContainer.getChildCount() > 0) {
                if (showFlag == 0) {
                    ...
                    updateIconTabSelection(mCurrentTab);
                }
                scrollToCurrentTab();
            }
        }
